...
//        textViewRow.titleImage = UIImage.init(named: "Image")
        textViewRow.attributedTitle = "输入框".withFont(UIFont.systemFont(ofSize: 15)) + "滑块".withFont(UIFont.systemFont(ofSize: 11)).withTextColor(.green)
...
//        switchRow.enabled = false
        switchRow.attributedTitle = "选择".withFont(UIFont.systemFont(ofSize: 15)) + "滑块".withFont(UIFont.systemFont(ofSize: 11)).withTextColor(.green)
